...
#define LEN_DATA 110 //Initially It was 90 changed to 110###########################################################################################################
...
class DW1000RangingClass {
  public:
    ...
    static void configureNetwork(unsigned int deviceAddress, unsigned int networkId, const byte mode[],byte channel); 
    static void generalStart();
    static void startAsAnchor(char address[], const byte mode[],byte channel);
    static void startAsTag(char address[], const byte mode[],byte channel);
  ...
  private: 
    ...
    volatile static short _networkDevicesNumber;
